			...
			<form:form action="shopRegistration.do" method="post" modelAttribute="shop" name="shopRegForm" id="shopRegForm">
				<table cellpadding="2" width="20%" bgcolor="99FFFF" align="center" cellspacing="2">
					...
					<tr>
						<td>SN Number</td>
						<td>
							<input type="text" name="snNumber" id="snNumber" required>
						</td>
					</tr>
					<tr>
						<td>Building Name</td>
						<td>
							<input type="text" name="buildingName" id="buildingName" size="30" required>
						</td>
					</tr>
					...
					<tr>
						<td>Landmark Name</td>
						<td>
							<input type="text" name="landmarkName" id="landmarkName" size="30" required>
						</td>
					</tr>
					...
					<tr>
						<td>Street Name</td>
						<td>
							<input type="text" name="streetName" id="streetName" size="30" required>
						</td>
					</tr>
					...
					<tr>
						<td>Locality/Area</td>
						<td>
							<input type="text" name="localityName" id="localityName" size="30" required>
						</td>
					</tr>
					...
					<tr>
						<td>Gender</td>
						<td>
							<input type="radio" name="ownerGender" id="ownerGender" value="M" size="10">Male
					...
					<tr>
						<td>PinCode</td>
						<td>
							<input type="text" name="pincode" id="pincode" size="30" required>
						</td>
					</tr>
					...
					<tr>
						<td>Name of Owner</td>
						<td>
							<input type="text" name="ownerName" id="ownerName" size="30" required>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<input type="text" name="registrationNumber" id="registrationNumber" size="30" required>
						</td>
					</tr>
					...
					<tr>
						<td>EmailId</td>
						<td>
							<input type="text" name="emailId" id="emailId" size="30" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" required>
						</td>
					</tr>
					...
					<tr>
						<td>User Id</td>
						<td>
							<input type="text" name="userId" id="userId" size="30" required>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<input type="text" name="establishDate" id="establishDate" size="30" required>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<input type="text" name="primaryContactNumber" id="primaryContactNumber" size="30" required>
						</td>
					</tr>
					...
					<tr>
						<td>Contact No</td>
						<td>
							<input type="text" name="contactNumber" id="contactNumber" size="30" required>
						</td>
					</tr>
					...
					<tr>
						<td>Tenant Name</td>
						<td>
							<input type="text" name="tenantName" id="tenantName" size="30" required>
						</td>
					</tr>
					...
					<tr>
						<td>Tenant Gender</td>
						<td>
							<input type="radio" name="tenantGender" id="tenantGender" value="M" size="10">Male
					...
					<tr>
						...
						<td>
							<select Name="establishType" id="establishType" required>
								<option value="SELECT" selected>SELECT</option>
					...
					<tr>
						...
						<td>
							<input type="text" name="locationCoOrdinates" id="locationCoOrdinates" size="30" required>
						</td>
					</tr>
					...
					<tr>
						<td>Working Hours</td>
						<td>
							<input type="text" name="workingHours" id="workingHours" size="30" required>
						</td>
					</tr>
					...
					<tr>
						<td>Working Days</td>
						<td>
							<input type="text" name="workingDays" id="workingDays" size="30" required>
						</td>
					</tr>
					...
					<tr>
						<td>Holiday</td>
						<td>
							<input type="text" name="workingOffDays" id="workingOffDays" size="30" required>
						</td>
					</tr>
